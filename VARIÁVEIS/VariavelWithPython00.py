...
variavel_5 = "mas é bom ressaltar que quando usamos virgula o valor irá ser expresso dentro de parênteses pois a linguagem entende que são dados separados"
variavel_6 = 7,5
